...
# 2. 打开你现有的完整 USD 场景文件
usd_scene_path = "/home/nnd/elfin_robot/elfin_description/urdf/elfin10_l/elfin10_l/elfin10_l.usd" 
...
gripper = ParallelGripper(
    end_effector_prim_path="/World/elfin10_l/ee_link/robotiq_arg2f_base_link",
...
camera_prim = XFormPrim(prim_paths_expr="/Camera") 
...
#elfin
# t_cv = np.array([-2.17267956e-14,  5.08678510e-01,  3.09715342e+00])
# R_cv = np.array([
#     [6.93890704e-17,  1.00000000e+00,  2.84331719e-17],
#     [7.46057815e-01,  0.00000000e+00, -6.65881173e-01],
#     [-6.65881173e-01,  0.00000000e+00, -7.46057815e-01]
# ])

# t_cv = np.array([0.54833896, 0.53521092, 2.60977823])
# R_cv = np.array([
#     [-5.84633335e-01,  8.11297618e-01,  1.93741202e-04],
#     [ 7.87263297e-01,  5.67371503e-01, -2.41466517e-01],
#     [-1.96011133e-01, -1.41016850e-01, -9.70409132e-01]
# ])

t_cv = np.array([-1.02348743,  0.1328453,   2.75823244])
R_cv = np.array([
 [ 0.09493143,  0.77343456,  0.62672722],
 [ 0.18626237,  0.60465157, -0.77440481],
 [-0.97790304,  0.19025105, -0.08666132]
])
